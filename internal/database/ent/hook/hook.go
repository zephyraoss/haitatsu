...
// The AppPasswordFunc type is an adapter to allow the use of ordinary
// function as AppPassword mutator.
type AppPasswordFunc func(context.Context, *ent.AppPasswordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AppPasswordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AppPasswordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AppPasswordMutation", m)
}
...
// Mutate calls f(ctx, m).
func (f DKIMKeyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DKIMKeyMutation); ok {
		return f(ctx, mv)
	}
...
// function as OutboundJob mutator.
type OutboundJobFunc func(context.Context, *ent.OutboundJobMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OutboundJobFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OutboundJobMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OutboundJobMutation", m)
}
